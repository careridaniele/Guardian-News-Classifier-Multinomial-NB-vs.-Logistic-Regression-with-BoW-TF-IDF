...
class Dataframe_Preprocessor:
    ...
    def __init__(self, df:pd.DataFrame, text_for_process=10, model="en_core_web_sm", use_gpu:bool = False, processor_number:int=-1, batch_size:int=20):
        self.__df = df
    ...
    def run(self):
        ...
        for i in range (0, self.__text_number, self.__text_for_process):
            ...
            if self.__use_gpu: torch.cuda.empty_cache()
